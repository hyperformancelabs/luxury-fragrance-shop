...
const Products = () => {
  ...
  // UI – filter popup visibility & anchor
  ...
  // Handle filter button click – toggle popup & remember anchor position
  ...
  // Handle search submit from toolbar (press Enter)
      ...
      <div className="mt-6">
        ...
        {selectedProducts.length > 0 && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4 flex items-center justify-between">
            ...
            <button
              ...
              className="bg-red-600 text-white px-4 py-2 rounded-lg flex items-center hover:bg-red-700 focus:outline-none"
            >
        ...
        {showFilters && (
          <div
            ...
            style={{ top: filterAnchor?.top, left: filterAnchor?.left, width: '250px' }}
          >
            ...
            <div className="space-y-4 max-w-full">
              ...
              {/* Price range */}
              <div className="space-y-2">
                <p className="text-sm font-semibold">Khoảng giá (VNĐ)</p>
                <input
                  type="number"
                  min="0"
                  step="10000"
              ...
              <div className="space-y-1">
                <p className="text-sm font-semibold">Dung tích</p>
                <select
