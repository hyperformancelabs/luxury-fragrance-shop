...
const BestSellingProduct = () => {
    ...
    return (
        <div className="flex flex-col mx-4 md:m-16 relative">
            <div className="w-full flex justify-between items-center mb-4">
                <h2 className="font-bold md:text-2xl">SẢN PHẨM BÁN CHẠY NHẤT</h2>
            ...
            <div className='flex justify-center items-center mb-4 w-full'>
                <div className='flex justify-center items-center w-1/2 gap-4'>
                    {categories.map((cat) => (
                        <button
                            key={cat.value}
                            className={`border-2 px-4 md:px-12 md:py-2 rounded text-base md:font-semibold transition duration-200
          ${selectedCategory === cat.value ? 'border-red-600 text-red-600 bg-red-50' : 'border-gray-300'}
        `}
