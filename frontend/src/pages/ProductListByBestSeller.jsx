...
const ProductListByBestSellerProduct = () => {
  ...
  const fetchProducts = async (page, currentSortBy) => {
    ...
    const endpoint = "http://localhost:8080/api/v1/products/best-seller";
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-wrap justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">Bộ sưu tập sản phẩm mới</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {loading ? (
            ...
            <p className="col-span-full text-center py-8 text-gray-500">Không có sản phẩm nào.</p>
          ) : (
...
export default ProductListByBestSellerProduct;
