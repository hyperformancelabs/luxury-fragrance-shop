import { ChevronLeft, ChevronLeftSquare, ChevronRight, ChevronRightSquare } from 'lucide-react'
  ...
  return (
    <div className='flex m-12 relative'>
        <div className="flex absolute -translate-y-4 translate-x-12 items-center bg-gradient-to-r from-red-500 to-red-700 text-white py-2 px-4 rounded-lg shadow-lg">
          <svg width="18" height="24" className="fill-yellow-300 animate-pulse" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-full h-full  items-center top-1/2 absolute'>
